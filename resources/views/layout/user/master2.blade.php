...
<html lang="en">
    ...
    <body>
        <!-- Responsive navbar-->
        <nav class="navbar navbar-expand-lg navbar-dark bg-hope-light">
            <div class="container px-5">                
                <a href="#"><img src="assets/img/logo_hope.png" alt="" srcset="" height="60px"></a>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2">Platform Investasi Pertanian Hidroponik Pertama di Indonesia</h1>
                            ...
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                                <a class="btn btn-outline-secondary btn-lg px-4 me-sm-3" href="#features">Daftar</a>
                                <a class="btn btn-success btn-lg px-4" href="#!">Mulai Investasi</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="bg-hope-green py-5 border-bottom">
            <div class="container px-5 my-5">
                <div class="text-center mb-5">
                    <h2 class="fw-bolder">Proyek Tersedia</h2>
                    <p class="lead mb-0">Mulai Investasi ke Proyek yang Tersedia</p>
                </div>
                <div class="row gx-5 justify-content-center">
                    <!-- Pricing card free-->
